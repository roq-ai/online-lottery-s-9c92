  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Online Lottery System - A new online lottery game for people worldwide, offering a chance to win prizes up to ₹5 Crore in every draw!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1518688248740-7c31f1a945c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsb3R0ZXJ5fGVufDB8fHx8MTY5ODA2MzA2OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Online Lottery System - A new online lottery game for people worldwide, offering a chance to win prizes up to ₹5 Crore in every draw!`}
            </Text>
            <Box
