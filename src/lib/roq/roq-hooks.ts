...
export function useLotteryGameFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLotteryGameFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.lottery_game.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLotteryGameCount<T extends Prisma.lottery_gameCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.lottery_gameCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useLotteryGameCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.lottery_game.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLotteryGameFindManyWithCount<
  T extends Prisma.lottery_gameFindManyArgs,
  R extends { data: GetFindResult<Prisma.$lottery_gamePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.lottery_gameFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLotteryGameFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.lottery_game.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLotteryGameFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLotteryGameFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.lottery_game.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWinnerFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWinnerFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.winner.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWinnerCount<T extends Prisma.winnerCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.winnerCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useWinnerCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.winner.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWinnerFindManyWithCount<
  T extends Prisma.winnerFindManyArgs,
  R extends { data: GetFindResult<Prisma.$winnerPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.winnerFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWinnerFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.winner.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useWinnerFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useWinnerFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.winner.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
